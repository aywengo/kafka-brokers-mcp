...
def load_cluster_configurations() -> KafkaClusterManager:
    ...
    if not manager.clusters:
        raise ValueError("No cluster configurations found. Set KAFKA_BOOTSTRAP_SERVERS or KAFKA_CLUSTER_NAME_X/KAFKA_BOOTSTRAP_SERVERS_X")
    ...
    try:
        ...
        return {
            ...
            "brokers": {
                ...
                "ids": list(metadata.brokers.keys())
            },
            "topics": {
